...
const MetaAdsSection = () => {
  ...
  const [metrics, setMetrics] = useState<MetaAdsMetrics | null>({
    adSpend: 8750.50,
    impressions: 125000,
    clicks: 8750,
    conversions: 175,
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 hover:border-[#1877F2] transition-colors">
              <h3 className="text-sm font-medium text-gray-500 flex items-center mb-1">
                <DollarSign size={16} className="mr-1 text-[#1877F2]" /> Ad Spend
              </h3>
              <p className="text-2xl font-semibold text-gray-900">
                ${metrics?.adSpend.toLocaleString()}
              </p>
            </div>
            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 hover:border-[#1877F2] transition-colors">
              <h3 className="text-sm font-medium text-gray-500 flex items-center mb-1">
                <TrendingUp size={16} className="mr-1 text-[#1877F2]" /> ROAS
              </h3>
              <p className="text-2xl font-semibold text-gray-900">
                {metrics?.roas}x
              </p>
            ...
            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 hover:border-[#1877F2] transition-colors">
              <h3 className="text-sm font-medium text-gray-500 flex items-center mb-1">
                <TrendingUp size={16} className="mr-1 text-[#1877F2]" /> ROI
              </h3>
              <p className="text-2xl font-semibold text-gray-900">
                {metrics?.roi}%
              </p>
            ...
            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 hover:border-[#1877F2] transition-colors">
              <h3 className="text-sm font-medium text-gray-500 flex items-center mb-1">
                <Users size={16} className="mr-1 text-[#1877F2]" /> Reach
              </h3>
              <p className="text-2xl font-semibold text-gray-900">
            ...
            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 hover:border-[#1877F2] transition-colors">
              <h3 className="text-sm font-medium text-gray-500 flex items-center mb-1">
                <MousePointer size={16} className="mr-1 text-[#1877F2]" /> CTR
              </h3>
              <p className="text-2xl font-semibold text-gray-900">
                {metrics?.ctr}%
              </p>
            ...
            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 hover:border-[#1877F2] transition-colors">
              <h3 className="text-sm font-medium text-gray-500 flex items-center mb-1">
                <Target size={16} className="mr-1 text-[#1877F2]" /> CPA
              </h3>
              <p className="text-2xl font-semibold text-gray-900">
                ${metrics?.cpa}
              </p>
                  ...
                  {metrics?.campaigns.map((campaign, index) => (
                    <tr 
                      ...
                      onClick={() => {
                        ...
                        console.log('View campaign details:', campaign.name);
                      }}
                    >
