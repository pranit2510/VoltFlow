...
const LeadEditPage = () => {
  ...
  return (
    <div>
      <div className='mb-6'>
        <Link href={`/leads/${leadData.id}`} className='inline-flex items-center text-sm text-primary hover:underline mb-3'>
          <ArrowLeft size={16} className="mr-1.5" /> Back to Lead Details
        </Link>
        <h1 className='text-3xl font-bold text-dark flex items-center'>
          <Lightbulb className="mr-3 h-8 w-8 text-primary" /> Edit Lead: {leadData.leadName}
        </h1>
      </div>
